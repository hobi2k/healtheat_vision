...
IMG_DIR = Config.DATA_DIR / "raw_processed" / "train_images"
ANN_DIR = Config.DATA_DIR / "raw_processed" / "train_annotations"
OUT_DIR = Config.DATA_DIR / "unified_dataset" / "annotations"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# YOLO 모델 로드
YOLO_MODEL = YOLO(str(Config.BASE_DIR / "outputs/models/hobi_yolov8_pill/weights/best.pt"))
