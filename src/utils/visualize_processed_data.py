...
if __name__ == "__main__":
    visualize_coco(
        img_dir=Config.DATA_DIR / "unified_dataset/images",
        ann_dir=Config.DATA_DIR / "unified_dataset/annotations",
        save_dir=Config.BASE_DIR / "outputs/visualization_unified"
    )
