...
def load_yolo_to_coco():
    ...
    """
    mapping_path = Config.DATA_DIR / "unified_dataset/annotations/category_mapping.json"
...
def inference(include_class_name=False):
    ...
    """
    # YOLO 모델 로드
    model_path = Config.BASE_DIR / "outputs/models/hobi_yolov8_pill_2u2/weights/best.pt"
