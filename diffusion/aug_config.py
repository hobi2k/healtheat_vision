...
class AugConfig:
    # 경로 설정
    image_dir: Path = Config.DATA_DIR / "clean_data/images"
    coco_json: Path = Config.DATA_DIR / "clean_dataset/annotations"

    out_image_dir: Path = Config.DATA_DIR / "outputs/aug_images"
    
    save_per_image_coco: bool = True
    out_coco_per_image_dir: Path = Config.DATA_DIR / "outputs/aug_annotations"

    # SAM 설정
    sam_checkpoint: Path = Config.BASE_DIR / "weights/sam_vit_h_4b8939.pth"
